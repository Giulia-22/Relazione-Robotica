...
nella sottocartella \texttt{plugin} della cartella \texttt{Functionality} di STAR. TODO \todo{sistemare dettagli importazione, come makefile, eliminazione main ecc...} \par
